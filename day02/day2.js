const rawInput = `Game 1: 4 red, 3 blue; 6 blue, 16 green; 9 blue, 13 green, 1 red; 10 green, 4 red, 6 blue
...
const createGame = (string) => {
  ...
  const numberId = string.indexOf(" ");
  const gameId = string.slice(numberId, startIndex);

  const game = string.slice(startIndex + 1);
